...
# We pull this in through the nubis settings file at the end
$wgServer = "";
...
$wgFavicon = "$wgStylePath/logos/favicon.ico";
...
## Database settings
# We pull these in through the nubis settings file at the end
$wgDBtype     = "mysql";
$wgDBserver   = "";
$wgDBname     = "";
$wgDBuser     = "";
...
# NOTE: This should remain at the end of this file in order to override
...
if (!empty($wgSquidServers)) {
    $wgUseSquid = true;
    $wgSquidServers = $wgSquidServers;
}
